...
crea( "chordef_startInteractive", $chordef_startInteractive, "chor" );
crea( "chordef_taichi", $chordef_taichi, "chor" );
crea( "chorstream_chorslist_1", $chorstream_chorslist_1, "chor" );
crea( "chorstream_chorslist_2", $chorstream_chorslist_2, "chor" );
crea( "chorstream_chorslist_3", $chorstream_chorslist_3, "chor" );
crea( "chorstream_chorslist_4", $chorstream_chorslist_4, "chor" );
crea( "chor_RFIDok", $chor_RFIDok, "chor" );
crea( "chordef_interactiveerror", $chordef_interactiveerror, "chor" );


crea( "mp3_startrecord", $mp3_startrecord, "mp3" );

crea( "midi_communion", $midi_communion, "mid" );
crea( "midi_acquired", $midi_acquired, "mid" );
crea( "midi_ministop", $midi_ministop, "mid" );
crea( "midi_abort", $midi_abort, "mid" );
crea( "midi_ears", $midi_ears, "mid" );
crea( "midi_ack", $midi_ack, "mid" );
crea( "midi_startInteractive", $midi_startInteractive, "mid" );
crea( "midi_endInteractive", $midi_endInteractive, "mid" );
crea( "midi_precedent", $midi_precedent, "mid" );
crea( "midi_suivant", $midi_suivant, "mid" );
crea( "midi_1noteA4", $midi_1noteA4, "mid" );
crea( "midi_1noteB5", $midi_1noteB5, "mid" );
crea( "midi_1noteBb4", $midi_1noteBb4, "mid" );
crea( "midi_1noteC5", $midi_1noteC5, "mid" );
crea( "midi_1noteE4", $midi_1noteE4, "mid" );
crea( "midi_1noteF4", $midi_1noteF4, "mid" );
crea( "midi_1noteF5", $midi_1noteF5, "mid" );
crea( "midi_1noteG5", $midi_1noteG5, "mid" );
crea( "midi_2notesC6C4", $midi_2notesC6C4, "mid" );
crea( "midi_2notesC6F5", $midi_2notesC6F5, "mid" );
crea( "midi_2notesD4A5", $midi_2notesD4A5, "mid" );
crea( "midi_2notesD4G4", $midi_2notesD4G4, "mid" );
crea( "midi_2notesD5G4", $midi_2notesD5G4, "mid" );
crea( "midi_2notesE5A5", $midi_2notesE5A5, "mid" );
crea( "midi_2notesE5C6", $midi_2notesE5C6, "mid" );
crea( "midi_2notesE5E4", $midi_2notesE5E4, "mid" );
crea( "midi_3notesA4G5G5", $midi_3notesA4G5G5, "mid" );
crea( "midi_3notesB5A5F5", $midi_3notesB5A5F5, "mid" );
crea( "midi_3notesB5D5C6", $midi_3notesB5D5C6, "mid" );
crea( "midi_3notesD4E4G4", $midi_3notesD4E4G4, "mid" );
crea( "midi_3notesE5A5C6", $midi_3notesE5A5C6, "mid" );
crea( "midi_3notesE5C6D5", $midi_3notesE5C6D5, "mid" );
crea( "midi_3notesE5D5A5", $midi_3notesE5D5A5, "mid" );
crea( "midi_3notesF5C6G5", $midi_3notesF5C6G5, "mid" );
crea( "midi_startrecord", $midi_startrecord, "mid" );
crea( "midi_endrecord", $midi_endrecord, "mid" );
crea( "midi_RFIDok", $midi_RFIDok, "mid" );




function crea($nf, $chor, $ext) {
    $chor= str_replace("\\","",$chor);
    $a=explode("$",$chor);
    array_shift($a);
